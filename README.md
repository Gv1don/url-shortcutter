...
<figure>
  ...
  <figcaption>Интерфейс просмотра всех кликов по всем ссылкам. Часть административного функционала.</figcaption>
</figure>
...
- Админ-панель Filament: управление всеми ссылками и кликами (доступна только администраторам)
...
> Админ-панель Filament доступна **только пользователям с ролью администратора**.
...
| Администратор| admin@shortcutter.test    | password  |
